...
const Place9 = () => {
    ...
    const slides = [
      {
        url: 'https://tourdefarm.in/wp-content/uploads/2021/01/Kaas-Plateau-.jpg',
      },
      {
        url: 'https://media-cdn.tripadvisor.com/media/photo-s/19/40/df/5d/table-land.jpg',
      },
      {
        url: 'https://media-cdn.tripadvisor.com/media/photo-s/0f/b5/98/55/sydney-point.jpg',
      },
  
      {
        url: 'https://cdn.pixabay.com/photo/2016/09/06/19/37/india-1650024_1280.jpg',
      },
      {
        url: 'https://th.bing.com/th/id/R.6b2fb6a9035f7e18b2aade124b9cbf88?rik=hh3hsX%2b7OMGCog&riu=http%3a%2f%2fwww.luxurytrailsofindia.com%2fwp-content%2fuploads%2f2017%2f06%2frajmachi-fort.jpg&ehk=8xIbc6fs47%2b3aEy%2b7SaEmvbE0xcjC3qVKfQVZGRNIh0%3d&risl=&pid=ImgRaw&r=0',
      },
    ];
  ...
  const handleSubmit = async (e) => {
    ...
    return (
      ...
      <p className='bg-black h-1 w-full px-0'></p>
        <h1 className='text-black font-light pt-8 uppercase'>Panchgani<span className='text-black font-semibold'> Maharashtra</span></h1>
        ...
        <p className='text-center pt-4 items-center font-light mx-auto flex text-lg justify-center'>Kaas Plateau, Table Land, Mapro Garden, Sydney Point</p>
    ...
    <section className="w-[900px] mx-auto px-8 justify-start pb-24 " aria-multiselectable="false">
        ...
        <div className="">
          ...
          <div className='flex items-center gap-4 font-semibold text-lg py-2'>
          <div><BsCheck2Circle size={20} className='text-green-500'/></div>Binoculars with night vision

          </div>
          <div className='flex items-center gap-4 font-semibold text-lg py-2'>
          <div><BsCheck2Circle size={20} className='text-green-500'/></div>Rain Gear

          </div>
          <div className='flex items-center gap-4 font-semibold text-lg py-2'>
          <div><BsCheck2Circle size={20} className='text-green-500'/></div>Butterfly net for insect observation
          ...
          <div className='flex items-center gap-4 font-semibold text-lg py-2'>
          <div><BsCheck2Circle size={20} className='text-green-500'/></div>High-resolution wildlife camera trap
          </div>
          <div className='flex items-center gap-4 font-semibold text-lg py-2'>
          <div><BsCheck2Circle size={20} className='text-green-500'/></div>Camping hammock with mosquito net
          </div>
          <div className='flex items-center gap-4 font-semibold text-lg py-2'>
          <div><BsCheck2Circle size={20} className='text-green-500'/></div>Torch or Flashlight
          </div>
          <div className='flex items-center gap-4 font-semibold text-lg py-2'>
          <div><BsCheck2Circle size={20} className='text-green-500'/></div>Travel Adapter
          </div>
          <div className='flex items-center gap-4 font-semibold text-lg py-2'>
          <div><BsCheck2Circle size={20} className='text-green-500'/></div>Travel Pillow,  Towel and Blanket
          </div>
          <div className='flex items-center gap-4 font-semibold text-lg py-2'>
          <div><BsCheck2Circle size={20} className='text-green-500'/></div>First Aid Kit & Snacks
          </div>

          <div className='flex items-center gap-4 font-semibold text-lg py-2'>
          <div><BsCheck2Circle size={20} className='text-green-500'/></div>Skin Care, toiletries and medications
          </div>

          <div className='flex items-center gap-4 font-semibold text-lg py-2'>
          <div><BsCheck2Circle size={20} className='text-green-500'/></div>Binoculars & compass
          </div>

          <div className='flex items-center gap-4 font-semibold text-lg py-2'>
          <div><BsCheck2Circle size={20} className='text-green-500'/></div>Basic needs for every travel
          </div>
          ...
          >
            <div className=''>
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d7592.268133734661!2d73.77436019357913!3d17.925899799999993!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc267775aa8149f%3A0x212a1c48408abeca!2sPanchgani%20Hill%20Station%20Point!5e0!3m2!1sen!2sin!4v1714301129334!5m2!1sen!2sin" width="100%" height="450" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </div>
          </div>
        </div>
      </section>
