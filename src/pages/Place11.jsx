...
const Place11 = () => {
    ...
    const slides = [
      {
        url: 'https://pawnacamp.com/wp-content/uploads/2019/07/Kune-waterfall-near-Lonavala.jpg',
      },
      {
        url: 'https://a.travel-assets.com/findyours-php/viewfinder/images/res70/75000/75453-Lonavala-And-Vicinity.jpg?impolicy=fcrop&w=1040&h=580&q=mediumHigh',
      },
      {
        url: 'https://www.touristpanda.com/wp-content/uploads/2023/01/Lonavala-Lake.jpg',
      },
  
      {
        url: 'https://d27k8xmh3cuzik.cloudfront.net/wp-content/uploads/2017/07/Stunning-monsoon-weekend-drives-from-Mumbai-Lonvala-1024x685.jpg',
      },
      {
        url: 'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/07/58/37/67/lohgarh-fort.jpg?w=1000&h=600&s=1',
      },
    ];
  ...
  const handleSubmit = async (e) => {
    ...
    return (
      ...
      <div>
        ...
        <h1 className='max-w-[1240px] px-6 mx-auto text-start items-center pt-8 font-semibold'>LONAVALA KHANDALA</h1>
        </div>
      ...
      <p className='bg-black h-1 w-full px-0'></p>
        <h1 className='text-black font-light pt-8'>LONAVALA <span className='text-black font-semibold'> KHANDALA</span></h1>
        ...
        <p className='text-center pt-4 items-center font-light mx-auto flex text-lg justify-center'>Lonavala</p>
    ...
    <section className="w-[900px] mx-auto px-8 justify-start pb-24 " aria-multiselectable="false">
        ...
        <div className="">
          ...
          <div className='flex items-center gap-4 font-semibold text-lg py-2'>
          <div><BsCheck2Circle size={20} className='text-green-500'/></div>Cave exploration gear

          </div>
          <div className='flex items-center gap-4 font-semibold text-lg py-2'>
          <div><BsCheck2Circle size={20} className='text-green-500'/></div>Local chikki sweets

          </div>
          <div className='flex items-center gap-4 font-semibold text-lg py-2'>
          <div><BsCheck2Circle size={20} className='text-green-500'/></div>Map of Lonavala trails

          </div>
          <div className='flex items-center gap-4 font-semibold text-lg py-2'>
          <div><BsCheck2Circle size={20} className='text-green-500'/></div>Scented candles
          </div>

          <div className='flex items-center gap-4 font-semibold text-lg py-2'>
          <div><BsCheck2Circle size={20} className='text-green-500'/></div>Bamboo wind chimes
          </div>

          <div className='flex items-center gap-4 font-semibold text-lg py-2'>
          <div><BsCheck2Circle size={20} className='text-green-500'/></div>Local artisan crafts
          </div>

          <div className='flex items-center gap-4 font-semibold text-lg py-2'>
          <div><BsCheck2Circle size={20} className='text-green-500'/></div>Ayurvedic massage oils
          </div>

          <div className='flex items-center gap-4 font-semibold text-lg py-2'>
          <div><BsCheck2Circle size={20} className='text-green-500'/></div>Rock climbing shoes
          </div>

          <div className='flex items-center gap-4 font-semibold text-lg py-2'>
          <div><BsCheck2Circle size={20} className='text-green-500'/></div>Biodegradable sunscreen
          </div>
          ...
          >
            <div className=''>
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d30221.138258673447!2d73.3611918923079!3d18.76950882184811!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be8012af5c2dcbd%3A0x4e9a732d604a9bd9!2sKhandala%2C%20Lonavala%2C%20Maharashtra!5e0!3m2!1sen!2sin!4v1714264010443!5m2!1sen!2sin" width="100%" height="450" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </div>
          </div>
        </div>
      </section>
