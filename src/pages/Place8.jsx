...
const Place8 = () => {
    ...
    const slides = [
      {
        url: 'https://static.toiimg.com/photo/99403459.cms',
      },
      {
        url: 'https://www.tusktravel.com/images/pahalgam-tusktravel.jpg',
      },
      {
        url: 'https://myhappytours.com/wpmht/wp-content/uploads/2017/08/gulmarg.jpg',
      },
  
      {
        url: 'https://www.tajhotels.com/content/dam/thrp/destinations/Srinagar/16x7intro/Srinagar-Final-16X7.jpg/_jcr_content/renditions/cq5dam.web.1280.1280.jpeg',
      },
  ...
  const handleSubmit = async (e) => {
    ...
    return (
      ...
      <div>
        ...
        <h1 className='max-w-[1240px] px-6 mx-auto text-start items-center pt-8 font-semibold'>MAGICAL KASHMIR</h1>
        </div>
      ...
      <p className='bg-black h-1 w-full px-0'></p>
        <h1 className='text-black font-light pt-8'>MAGICAL<span className='text-black font-semibold'> KASHMIR</span></h1>
        ...
        <p className='text-center pt-4 items-center font-light mx-auto flex text-lg justify-center'>Srinagar, Sonmarg, Gulmarg</p>
    ...
    {weatherData.current.humidity >= 60 ? (
      ...
      <div>
        <p></p>
          ...
          >
            <div className=''>
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3447.4343392312867!2d78.79605407501741!3d30.224688210009262!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3909a51dccce4e43%3A0xbee78f18b48f6786!2sSrinagar%20Kashmir!5e0!3m2!1sen!2sin!4v1714399300525!5m2!1sen!2sin" width="100%" height="450"  allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </div>
          </div>
        </div>
      </section>
