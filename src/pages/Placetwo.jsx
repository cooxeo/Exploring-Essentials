  ...
  const handleSubmit = async (e) => {
    ...
    return (
      ...
      <div>
        ...
        <h1 className='max-w-[1240px] px-6 mx-auto text-start items-center pt-8 font-semibold'>AMAZING ANDAMAN</h1>
        </div>
      ...
      <p className='bg-black h-1 w-full px-0'></p>
        <h1 className='text-black font-light pt-8'>AMAZING<span className='text-black font-semibold'> ANDAMAN</span></h1>
        ...
        <p className='text-center pt-4 items-center font-light mx-auto flex text-lg justify-center'>Port Blair, Havelock Island, Neil Island</p>
      ...
      <div className='flex items-center gap-2 py-8  max-w-[1240px] px-4'>
        <div><BsGlobe2 size={20} /></div> <p className='sm:flex flex-wrap gap-1'><span className='font-bold'>Available languages: </span>    English And Local Language of that palce.</p>
      </div>
    </div>
    ...
    <section className="w-[900px] mx-auto px-8 justify-start pb-24 " aria-multiselectable="false">
        ...
        <div className="">
          ...
          <div className='flex items-center gap-4 font-semibold text-lg py-2'>
            ...
            Travel Documents & Local Currency
...
Camera
          ...
          <div className='flex items-center gap-4 font-semibold text-lg py-2'>
          <div><BsCheck2Circle size={20} className='text-green-500'/></div>Reusable Water Bottle
          </div>

          <div className='flex items-center gap-4 font-semibold text-lg py-2'>
          <div><BsCheck2Circle size={20} className='text-green-500'/></div>Comfortable Footwear & Water Shoes.
          ...
          <div className='flex items-center gap-4 font-semibold text-lg py-2'>
          <div><BsCheck2Circle size={20} className='text-green-500'/></div>Travel Adapters and Chargers & camera
          </div>

          <div className='flex items-center gap-4 font-semibold text-lg py-2'>
          <div><BsCheck2Circle size={20} className='text-green-500'/></div>Backpack or Daypack
          </div>

          <div className='flex items-center gap-4 font-semibold text-lg py-2'>
          <div><BsCheck2Circle size={20} className='text-green-500'/></div>Swimwear & Lightweight Clothing
          </div>

          <div className='flex items-center gap-4 font-semibold text-lg py-2'>
          <div><BsCheck2Circle size={20} className='text-green-500'/></div>Guidebook or Map
          </div>
          ...
          >
            <div className=''>
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1997625.50572827!2d91.34194232357508!3d12.070173560597224!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a3b4b6952b75e79%3A0xcbed2a52b1715b9f!2sAndaman%20Islands!5e0!3m2!1sen!2sus!4v1714135074040!5m2!1sen!2sus" width="100%" height="450" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </div>
          </div>
        </div>
      </section>
