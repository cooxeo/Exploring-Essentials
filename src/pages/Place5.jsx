  ...
  const handleSubmit = async (e) => {
    ...
    return (
      ...
      <div>
        ...
        <h1 className='max-w-[1240px] px-6 mx-auto text-start items-center pt-8 font-semibold'>EXQUISITE KARNATAKA</h1>
        </div>
      ...
      <p className='bg-black h-1 w-full px-0'></p>
        <h1 className='text-black font-light pt-8'>EXQUISITE<span className='text-black font-semibold'> KARNATAKA</span></h1>
        ...
        <p className='text-center pt-4 items-center font-light mx-auto flex text-lg justify-center'>Bhramagiri hill station</p>
    ...
    {weatherData.current.humidity >= 60 ? (
      ...
      <div>
        <p></p>
          ...
          >
            <div className=''>
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d31170.180507029036!2d75.7142702092622!3d12.4315514438423!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ba5ab5036dabe63%3A0xa5427a5e008be79e!2sBhramagiri%20Hills%20Viewpoint!5e0!3m2!1sen!2sin!4v1714398973623!5m2!1sen!2sin" width="100%" height="450" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </div>
          </div>
        </div>
      </section>
