...
const Place10 = () => {
    ...
    const slides = [
      {
        url: 'https://www.holidify.com/images/cmsuploads/compressed/shutterstock_633164246_20190904103856_20190904103926.jpg',
      },
      {
        url: 'https://travel.clickforholiday.com/image/202023230150.jpg',
      },
      {
        url: 'https://swastiktours.com/wp-content/uploads/2016/12/Delhi-Shimla-Kullu-Manali-Chandigarh-student-tour.jpg',
      },
  
      {
        url: 'https://media.tacdn.com/media/attractions-splice-spp-674x446/07/54/7b/27.jpg',
      },
  ...
  const handleSubmit = async (e) => {
    ...
    return (
      ...
      <div>
        ...
        <h1 className='max-w-[1240px] px-6 mx-auto text-start items-center pt-8 font-semibold'>MYSTICAL HIMACHAL</h1>
        </div>
      ...
      <p className='bg-black h-1 w-full px-0'></p>
        <h1 className='text-black font-light pt-8'>MYSTICAL<span className='text-black font-semibold'> HIMACHAL</span></h1>
        ...
        <p className='text-center pt-4 items-center font-light mx-auto flex text-lg justify-center'>Shimla, Manali, Chandigarh</p>
    ...
    {weatherData.current.humidity >= 60 ? (
      ...
      <div>
        <p></p>
          ...
          >
            <div className=''>
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d109348.20372531425!2d77.00312352678357!3d31.078272679853345!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390578e3e35d6e67%3A0x1f7e7ff6ff9f54b7!2sShimla%2C%20Himachal%20Pradesh!5e0!3m2!1sen!2sin!4v1714397752768!5m2!1sen!2sin" width="100%" height="450" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </div>
          </div>
        </div>
      </section>
