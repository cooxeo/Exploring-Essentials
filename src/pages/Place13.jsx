  ...
  const handleSubmit = async (e) => {
    ...
    return (
      ...
      <div>
        ...
        <h1 className='max-w-[1240px] px-6 mx-auto text-start items-center pt-8 font-semibold'>GOA</h1>
        </div>
      ...
      <p className='bg-black h-1 w-full px-0'></p>
        <h1 className='text-black font-light pt-8'><span className='text-black font-semibold'> GOA</span></h1>
        ...
        <p className='text-center pt-4 items-center font-light mx-auto flex text-lg justify-center'>Goa</p>
    ...
    {weatherData.current.humidity >= 60 ? (
      ...
      <div>
        <p></p>
          ...
          >
            <div className=''>
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d984956.6951314246!2d73.3471910483667!3d15.350084489106958!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bbfba106336b741%3A0xeaf887ff62f34092!2sGoa!5e0!3m2!1sen!2sin!4v1714398092538!5m2!1sen!2sin" width="100%" height="450"  allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </div>
          </div>
        </div>
      </section>
