...
const Place4 = () => {
    ...
    const slides = [
      {
        url: 'https://www.team-bhp.com/forum/attachments/travelogues/301809d1267910431-short-trip-hyderabad-bhadrachalam-papikondalu-b14.jpg',
      },
      {
        url: 'https://papikondalu.net.in/assets/images/papikondalu-tour-package-from-srikakulam-800x500.png',
      },
      {
        url: 'https://www.adotrip.com/public/images/areas/master_images/5e4143db7f94c-Papikondalu_Attractions.jpg',
      },
  ...
  const handleSubmit = async (e) => {
    ...
    return (
      ...
      <div>
        ...
        <h1 className='max-w-[1240px] px-6 mx-auto text-start items-center pt-8 font-semibold'>EXCITING ANDHRA PRADESH </h1>
        </div>
      ...
      <p className='bg-black h-1 w-full px-0'></p>
        <h1 className='text-black font-light pt-8'>PAPIKONDALU<span className='text-black font-semibold'> FOREST</span></h1>
        ...
        <p className='text-center pt-4 items-center font-light mx-auto flex text-lg justify-center'>PAPIKONDALU FOREST</p>
    ...
    {weatherData.current.humidity >= 60 ? (
      ...
      <div>
        <p></p>
          ...
          >
            <div className=''>
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1946435.6187290365!2d79.10671234130862!3d17.66757688459035!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a3727dba9f0c1bf%3A0x21f50f53a684e22!2sPapikonda%20National%20Park!5e0!3m2!1sen!2sin!4v1714398778325!5m2!1sen!2sin" width="100%" height="450"  allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </div>
          </div>
        </div>
      </section>
