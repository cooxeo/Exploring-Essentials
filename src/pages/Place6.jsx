  ...
  const handleSubmit = async (e) => {
    ...
    return (
      ...
      <div>
        ...
        <h1 className='max-w-[1240px] px-6 mx-auto text-start items-center pt-8 font-semibold'>KASHMIR GULMAR</h1>
        </div>
      ...
      <p className='bg-black h-1 w-full px-0'></p>
        <h1 className='text-black font-light pt-8'>KASHMIR<span className='text-black font-semibold'> GULMAR</span></h1>
        ...
        <p className='text-center pt-4 items-center font-light mx-auto flex text-lg justify-center'>Dal Lake, Gulmar</p>
    ...
    {weatherData.current.humidity >= 60 ? (
      ...
      <div>
        <p></p>
          ...
          >
            <div className=''>
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d13222.942463178355!2d74.36274135067897!3d34.05065239923395!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x38e1af91308dd977%3A0x7a5cc65c8fb01df7!2sGulmarg%20193403!5e0!3m2!1sen!2sin!4v1714399118396!5m2!1sen!2sin" width="100%" height="450"  allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </div>
          </div>
        </div>
      </section>
