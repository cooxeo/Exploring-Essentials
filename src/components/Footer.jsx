...
import {FaRegFaceGrinWink,FaAngleUp} from 'react-icons/fa6'
...
export default function Footer() {
    ...
    return (
        // <footer className="bg-[#0c0c0c] border-y border-[#1c2424] ">
        //     <div>
        //         <div className='flex flex-wrap justify-between mx-auto max-w-screen-xl mt-8 px-10 items-center'>
        //         <h1 className='font-bold text-3xl text-gray-100 sm:mt-0 center space-x-5 mx-2'>Exploring <span className='text-orange-700'>Essentials.</span></h1>
        //         <div>
        ...
        //         <div className='flex flex-wrap justify-between mx-auto  mt-8 px-4 mb-14 max-w-[1240px]'>
        //             <h1 className='text-gray-500 text-sm mx-2 mt-2'>© 2023 | Exploring Essentials | Privacy | Cookies</h1>

        //             <dev className='flex pt-10 sm:pt-0'>
        //             <h2 className='text-gray-500 text-lg font-sans font-bold flex items-center gap-2 mx-2 '><FaRegFaceGrinWink size={20}/>Adventure Is Out There</h2>
        //             <div className='justify-end flex mx-auto max-w-screen-xl '>
        ...
        <div class=" md:w-[1240px] px-10 w-full text-white flex flex-col">
            ...
            <div class="flex flex-col">
                <div class="sm:flex mt-24 mb-12 flex-row justify-between hidden ">
                    <div className='text-2xl text-gray-400'>Quick Links.</div>
                    <NavLink onClick={scrollToTop}
                                to="/home" className="hidden md:block cursor-pointer text-gray-600 hover:text-white uppercase">Home</NavLink>
                    <NavLink onClick={scrollToTop}
                                to="/contact" className="hidden md:block cursor-pointer text-gray-600 hover:text-white uppercase">Contact</NavLink>
                    <NavLink onClick={scrollToTop}
                                to="/safety" className="hidden md:block cursor-pointer text-gray-600 hover:text-white uppercase">Safety Travel Tips</NavLink>
                    <NavLink onClick={scrollToTop}
                                to="/about" className="hidden md:block cursor-pointer text-gray-600 hover:text-white uppercase">About</NavLink>
                ...
                <p class="w-full text-center my-12 text-gray-600">Copyright © 2024 Exploring <span className='text-orange-500'>Essintials</span></p>
            </div>
        </div>
    </div>
    );
